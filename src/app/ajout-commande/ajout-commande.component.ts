...
export class AjoutCommandeComponent implements OnInit {
  ...
  constructor(private services : CommandeService , private router : Router,private fb:FormBuilder,private toast :NgToastService) {
    let formControls = {
 ...
 /* AddCommande() {
    ...
    this.services.ajouterCommande(commande).subscribe(
      res=>{
        console.log(res);
  ...
  addCommande() {
    ...
    this.services.ajouterCommande(cmd).subscribe(
      res=>{
        console.log(res);
        this.toast.success({
